...
if __name__ == '__main__':
    ...
    configfile = "{}/local/{}".format(approot, args.config)
    
    # Load application
    try:
        import ucsnew
        from ucsnew import application as app
    ...
    app = app.create_app(app.app, configfile=configfile)
    ...
    for i in legacy_items_l:
        ...
        new_item_d = new_item.as_api_dict()
        print(new_item_d)
        itemnumber += 1
