...
item_model = {
   ...
   'price': fields.String(required=True, description='Friday price', example="1.00"),
   'discountprice': fields.String(required=True, description='Saturday price', example="1.00"),
   ...
   'checkedin': fields.String(required=False, description='The presense of a datetime indicates checkedin'),
   'checkedout': fields.String(required=False, description='The presense of a datetime indicates sold'),
